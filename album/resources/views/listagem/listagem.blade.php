    ...
    <tbody>
        @foreach($figurinhas as $figurinha)
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('destroyFigurinha', $figurinha->id )}}" class="btn btn-outline-dark" name="excluir" id="excluir">
                        ...
                        <a href="{{route('editFigurinha', $figurinha->id )}}" class="btn btn-outline-dark" name="excluir" id="excluir">
